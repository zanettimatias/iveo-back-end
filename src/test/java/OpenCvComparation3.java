...
public class OpenCvComparation3 {
    ...
    public final String img3Url = "./Users/mzanetti/IdeaProjects/iveo-backend/src/test/resources/H1to3p.png";
    @Test
    public void comparate(){
        nu.pattern.OpenCV.loadLocally();

        Mat imgObject = Imgcodecs.imread(img1Url, Imgcodecs.IMREAD_GRAYSCALE);
        Mat imgScene = Imgcodecs.imread(img2Url, Imgcodecs.IMREAD_GRAYSCALE);
        ...
        System.out.println("*******************************");
        System.out.println("# Keypoints 1:                        \t" + listOfKeypointsObject.size());
        System.out.println("# Keypoints 2:                        \t" + listOfKeypointsScene.size());
